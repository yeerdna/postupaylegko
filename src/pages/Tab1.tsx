        ...
        <div className="hero-wrap">
          <div className="hero-section">
            ...
            <div className="hero-text">
              <h1>
                ПоступайЛегко - <br /> помощник <br />
                абитуриента
              </h1>
            </div>
          </div>
          <p className="hero-desc">
            Поступление - проще, чем кажется. <b>ПоступайЛегко</b> помогает
            разобраться в приёма, сроках и документах. Понятные шаги, краткие
            ответы и только проверенная информация - все в одном месте.{" "}
          </p>
        </div>
            ...
            >
              <SwiperSlide>
                <div className="slide">
                  ...
                  <p>
                    <b>Вопросы и ответы</b> <br /> Краткие и понятные ответы на
                    самые частые <br /> вопросы абитуриентов: <br /> документы,
                    ЕГЭ, сроки, приёмные комиссии, зачисление.
                  </p>
                  <p>
